...
class Parent(cfrl.agent.AttributeSavingMixin, object):
...
class Child(cfrl.agent.AttributeSavingMixin, object):
...
class Parent2(cfrl.agent.AttributeSavingMixin, object):
...
class TestAttributeSavingMixin(unittest.TestCase):
    ...
    def test_loop1(self):
        ...
        # The assertion in cfrl should fail on save().
