...
# fmt: off
parser = argparse.ArgumentParser(description='CFRL Experiment Submission')
...
if not args.wandb_key:
    try:
        args.wandb_key = requests.utils.get_netrc_auth(
            "https://api.wandb.ai")[-1]
    except:
        pass
